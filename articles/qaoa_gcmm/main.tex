...
connectivity also compiles to a shallow gate-model circuit. We validate
every neighborhood on a simulator before spending any hardware time, so
the QPU only confirms the final result.
